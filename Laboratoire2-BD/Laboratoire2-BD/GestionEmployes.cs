...
namespace Laboratoire2_BD
{
    public partial class GestionEmployes : Form
    {
        ...
        // true si lister / false si rechercher 
        bool RechercherOuLister = true;
        ...
        private void Lister()
        {
            try
            {
                ...
                codedep.Value = CB_CodeDepLister.SelectedItem.ToString();

                oraliste.Parameters.Add(liste);
                oraliste.Parameters.Add(codedep);
                ...
                {
                    MessageBox.Show("Il n'y a aucun employé dans ce département");
                    ReinitialiseLabelLister();
                }
        ...
        private void InitLabelLister()
        {
            LB_NumList.DataBindings.Add("Text", monDataSet, "lister.numemp");
            LB_NomList.DataBindings.Add("Text", monDataSet, "lister.nomemp");
            LB_PrenomList.DataBindings.Add("Text", monDataSet, "lister.Prenomemp");
            LB_SalaireList.DataBindings.Add("Text", monDataSet, "lister.Salaireemp");
            LB_CodeDepList.DataBindings.Add("Text", monDataSet, "lister.CodeDep");
        }
        private void ReinitialiseLabelLister()
        {
        ...
        private bool Rechercher()
        {
            ...
            try
            {
                ...
                OrapameResultat.Direction = ParameterDirection.Output;
        ...
        private void InitLabelRechercher()
        {
            LB_NumList.DataBindings.Add("Text", monDataSet, "Employés.numemp");
            LB_NomList.DataBindings.Add("Text", monDataSet, "Employés.nomemp");
            LB_PrenomList.DataBindings.Add("Text", monDataSet, "Employés.Prenomemp");
            LB_SalaireList.DataBindings.Add("Text", monDataSet, "Employés.Salaireemp");
            LB_CodeDepList.DataBindings.Add("Text", monDataSet, "Employés.CodeDep");
        }
        private void ReinitialiseLabelRechercher()
        {
            LB_NumList.DataBindings.Clear();
            LB_NomList.DataBindings.Clear();
            LB_PrenomList.DataBindings.Clear();
